...
<div v-click="0" class="absolute inset-0 flex justify-center items-center">
  <figure class="text-center w-full h-full">
    <img src="/figures/radiation_budget.jpg" alt="Image 1" class="w-full h-full object-contain">
    <figcaption class="text-3 mt-2">
      Blue sky and white cloud
      <div class="text-2">(Source: unsplash.com)</div>
    </figcaption>
...
<table class="w-full border-collapse border text-center text-3 mt-15">
  <thead>
    <tr class="font-bold">
      <th class="border px-3 py-2" colspan="2">Application</th>
  ...
  <tbody>
    <tr>
      <td class="border px-3 py-2" rowspan="2">Climate studies</td>
      <td class="border px-3 py-2">Understanding the Earth's Radiation Budget</td>
    ...
    <tr>
      <td class="border px-3 py-2" rowspan="2">Remote sensing</td>
      <td class="border px-3 py-2">Rainfall rate estimation</td>
      <td class="border px-3 py-2"></td>
      <td class="border px-3 py-2"></td>
      <td class="border px-3 py-2"></td>
    ...
    <tr>
      <td class="border px-3 py-2">Radiation force</td>
      <td class="border px-3 py-2">Particle traping and manipulation</td>
      <td class="border px-3 py-2">nano - micro meters</td>
      <td class="border px-3 py-2">visible - near infrared</td>
      <td class="border px-3 py-2">Biological cells, conducting particles</td>
    </tr>
  </tbody>
</table>
...
<v-drag pos="647,337,164,_">
  <div v-click="4" v-click.hide="5" text-center text-3 border border-main rounded>
...
$$
\begin{aligned}
{f}_{i}(\vec{x} + \vec{c}_i\Delta t, t + \Delta t) &= f_i (\vec{x} ,t) + \Delta t D_i f_i (\vec{x} ,t) +  \frac{( \Delta t)^2}{2} D_i^2 f_i (\vec{x} ,t) + O(\Delta t^3) \\[1.0em]
D_i &= \left(\frac{\partial}{\partial t} + \pmb{c}_i \cdot \pmb{\nabla} \right) 
\end{aligned}
$$
</div>
...
$$
\begin{aligned}
f_i = \sum_{n=0} (\Delta t)^n f_i^{(n)} \hspace{10pt} \textcolor{grey}{and} \hspace{10pt} D_i = \sum_{n=0} (\Delta t)^n D_i^{(n)}
\end{aligned}
$$
</div>
...
<div v-click class="text-2.5">
$$
\text{Assuming} \hspace{10pt} D_i \approx D_i^{(0)}
$$
</div>

<div v-click class="text-2.5">
$$
f_i = f_i^{eq} - \tau (\Delta t) D_i f_i^{eq} + \tau (\Delta t)^2 \left( \tau - \frac{1}{2} \right) D_i^2 f_i^{eq} + O((\Delta t)^3)
$$
</div>
...
$$
\begin{aligned}
\sum_{i} f_i = \sum_{i} f_i^{eq} \hspace{10pt} \textcolor{grey}{and} \hspace{10pt} D_i \approx D_i^{(0)} \hspace{10pt} \text{we get} \hspace{10pt} \boxed{\sum_{i} D_i f_i^{eq} \approx 0} 
\end{aligned}
$$
</div>
...
<div v-click class="mt-1 text-2.5">
...
<div v-click.hide="3" class="absolute grid grid-cols-2 gap-15 mt-15 place-items-center transition-opacity duration-100 opacity-100">
  ...
  $$
  \begin{aligned}
  \left| \frac{\vec{E_{0_R}}}{\vec{E_{0_I}}}  \right| &= \left| \frac{1 - \beta}{1 + \beta} \right| \\[2.0em]
  \left| \frac{\vec{E_{0_T}}}{\vec{E_{0_I}}}  \right| &= \left| \frac{2}{1 + \beta} \right| \\[3.0em]
...
<figure v-click="1"  class="text-center mt-5">
...
<figure v-click="2" class="flex text-center w-3/4 mt-10">
...
<div v-click="5" class="mt-1 text-3">
...
<div v-click="1" class="grid grid-cols-2 gap-1 place-items-center justify-center mt-2">
  <figure class="flex flex-col items-center">
    <img src="/figures/JCP/EzTot_er_2_Real_1.png" alt="Image 1" class="w-2.6/4 h-auto">
  </figure>

  <figure class="flex flex-col items-center">
    <img src="/figures/JCP/EzTot_er_5_Real_1.png" alt="Image 2" class="w-2.6/4 h-auto">
  </figure>

  <figure class="flex flex-col items-center">
    <img src="/figures/JCP/EzTot_er_10_Real_1.png" alt="Image 3" class="w-2.6/4 h-auto">
  </figure>

  <figure class="flex flex-col items-center">
    <img src="/figures/JCP/EzTot_er_20_Real_1.png" alt="Image 4" class="w-2.6/4 h-auto">
  </figure>
</div>



<v-drag pos="23,271,55,_">
<div v-click="1"  class="text-3 text-left">
$$
a / \lambda = 1
$$
...
<div class="flex items-start justify-left h-full mt-20">
  <ul class="list-disc text-left">
    <li>Developed an in-house code</li>
    <li>Validated LBM for scattering and radiation force calculations</li>
  </ul>
</div>
